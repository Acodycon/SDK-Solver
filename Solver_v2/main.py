...
class MainGUI:
    ...
    def __init__(self):
        ...
        self.choose_solving_alg_combo_box = ctk.CTkComboBox(master=self.solve_button_frame)
        ...
        self.generating_alg_label.grid(row=3, padx=(25, 0), pady=(35, 25), sticky="w")
        ...
        self.recursions_made_label.grid(row=4, padx=(25, 0), pady=(10, 0), sticky="w")
        ...
        self.reductions_checked_label.grid(row=5, padx=(25, 0), pady=(10, 0), sticky="w")
        ...
        self.board_label.grid(row=6, padx=(25, 0), pady=(35, 25), sticky="w")
        ...
        self.numbers_given_label.grid(row=7, padx=(25, 0), pady=(10, 0), sticky="w")
        ...
        self.numbers_resolved_label.grid(row=8, padx=(25, 0), pady=(10, 0), sticky="w")
        ...
        self.numbers_unresolved_label.grid(row=9, padx=(25, 0), pady=(10, 0), sticky="w")
        ...
        self.possible_values_remaining_label.grid(row=10, padx=(25, 0), pady=(10, 0), sticky="w")
        ...
        self.cell_label.grid(row=11, padx=(25, 0), pady=(35, 25), sticky="w")
        ...
        self.cell_row_label.grid(row=12, padx=(25, 0), pady=(10, 0), sticky="w")
        ...
        self.cell_col_label.grid(row=13, padx=(25, 0), pady=(10, 0), sticky="w")
        ...
        self.cell_value_label.grid(row=14, padx=(25, 0), pady=(10, 0), sticky="w")
        ...
        self.cell_pV_label.grid(row=15, padx=(25, 0), pady=(10, 0), sticky="w")
